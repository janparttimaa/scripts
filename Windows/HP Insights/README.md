...
> <img src= "./img/screenshot01.png" alt="Screenshot of Microsoft Intune requirement rule settings for the additional requirements script used by the HP Insights app.">
